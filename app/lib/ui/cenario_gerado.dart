...
const List<FormaDoGato> gato = [
  ...
  FormaDoGato.traco('M8 -14 Q17 -17 16 -26', 0xFFC9CBE0, 2.5),
  FormaDoGato.disco(16, -27, 2.5, 0xFF39FF14),
  ...
  FormaDoGato.forma('M-8 -18 L-7 -6 L7 -6 L8 -18 Q0 -21 -8 -18 Z', 0xFF2A1B4D),
  FormaDoGato.traco('M-6 -18 Q0 -15 6 -18', 0xFFFF2D95, 1.8),
