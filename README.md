...
[![Testes](https://img.shields.io/badge/testes-349%20passando-39FF14?style=flat-square)](https://github.com/gustavoanderson/DevLingo/actions/workflows/ci.yml)
...
Oito trilhas de nível iniciante, **50 questões cada**:
...
**349 testes automatizados**, e a maioria nasceu de um defeito real. Cada correção vira teste, e cada teste é verificado **removendo a correção de propósito** para ver se ele falha. Os números ficam nas mensagens de commit: `Actual: 0.0`, `Actual: 111.0`, `Found 0 widgets`.
...
**O que existe:** as oito trilhas iniciantes, login com conta, sincronização entre aparelhos, estatísticas do jogador, tela de título em formato de fliperama, cenário animado, realce de sintaxe e som opcional.
